# Development and Testing Guide <br/> Pip.Services Expressions for .NET
...
```bash
git clone git@github.com:pip-services3/pip-services3-expressions-dotnet.git
```
...
```bash
nuget pack PipServices3.Expressions.nuspec
```

Publish the package on nuget global repository

```bash
nuget push PipServices3.Expressions.XXX.nupkg -Source https://www.nuget.org/api/v2/package
```
